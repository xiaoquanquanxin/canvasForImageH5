...
export const imgMap: ImgMap = {
	airplane: {name: "airplane", src: airplane, img: new Image(), size: 4889, initiallyY: 1.4 * canvasHeight},
	...
	cover: {name: "cover", src: cover, img: new Image(), size: 60190, initiallyY: 0},
